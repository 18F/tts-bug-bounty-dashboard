    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('triaged', 'triaged'), ('not-applicable', 'not-applicable'), ('spam', 'spam'), ('new', 'new'), ('resolved', 'resolved'), ('duplicate', 'duplicate'), ('informative', 'informative'), ('needs-more-info', 'needs-more-info')], max_length=30)),
