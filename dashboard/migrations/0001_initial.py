# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-22 11:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('not-applicable', 'not-applicable'), ('duplicate', 'duplicate'), ('spam', 'spam'), ('informative', 'informative'), ('needs-more-info', 'needs-more-info'), ('resolved', 'resolved'), ('new', 'new'), ('triaged', 'triaged')], max_length=30)),
